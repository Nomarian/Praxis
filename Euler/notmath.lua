...
-- math.lua for the good functions, this is all of my scribbles
...
-- isprime4 should be primefiller, that is, check in db for prime and use
-- the primelist to check for primes, filling the list if its not there
-- isprime5 should be isprime2 until a certain amount then it drops to
-- primefiller method
